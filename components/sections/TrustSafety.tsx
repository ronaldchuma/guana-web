...
const PILLARS: TrustPillar[] = [
  {
    ...
    description: "No guessing who's showing up",
  },
  {
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    description: "Everything stays in the app",
  },
  {
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    description: "Follow along on a live map",
  },
  {
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-[30px] w-full mt-4">
          {PILLARS.map((pillar) => (
            <div key={pillar.title} className="flex flex-col items-center gap-[10px] text-center">
              <div className="w-6 h-6 flex items-center justify-center">{pillar.icon}</div>
