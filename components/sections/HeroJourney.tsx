            ...
            <div className="container-guana">
              ...
              <div className="mt-8">
                <Button
                  href={APP_STORE_URL}
                  size="lg"
                  className="bg-teal text-lime hover:bg-teal-600 active:bg-teal-700 shadow-lg"
                >
                  {hero.cta}
                </Button>
              </div>
          ...
          <div className="container-guana">
            ...
            >
              <Button
                href={APP_STORE_URL}
                size="lg"
                className="bg-teal text-lime hover:bg-teal-600 active:bg-teal-700 shadow-lg hover:shadow-xl"
              >
                {hero.cta}
                <svg
        ...
        >
          ...
          <div className="mt-8">
            <Button
              href={APP_STORE_URL}
              size="lg"
              className="bg-teal text-lime hover:bg-teal-600 active:bg-teal-700 shadow-lg hover:shadow-xl pointer-events-auto"
            >
              {hero.cta}
              <svg
                className="ml-2 h-4 w-4"
